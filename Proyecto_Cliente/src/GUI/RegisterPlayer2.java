...
public class RegisterPlayer2 extends JFrame  implements ActionListener{
			...
			try {
				if(Main.getRemote().verification(namePlayer, passwordPlayer)){
					if(Main.getRemote().infoPlayerActivate()==null){
						Main.getRemote().writeStatePlayerTwo("1;"+namePlayer+";");
						int matriz [][] = new int[8][8];
						GameInit select = new GameInit("player 2", new PanelSea("right", matriz));
